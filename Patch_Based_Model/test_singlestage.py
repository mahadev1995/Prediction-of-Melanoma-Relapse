...
# Define evaluation mode ('val' or 'test'), method, checkpoint number, and model name
mode = 'val'
method = 'single_stage'
ckpt_num = 33
modelName = 'resnet34'
...
# Define paths for output files and data
...
ckpt_path = f'./checkpoints/resnet34_singlestage_focal_loss/checkpoint_{ckpt_num}.ckp'
