...
test_dataset = MelanomaDataset(test_labels, meta_data, meta_labels, data_path, transforms=transform)
...
np.save('./prediction/prediction.npy', predictions)
...
plt.savefig('./prediction/confusion_matrix_val.png')
plt.savefig('./prediction/confusion_matrix_val.svg')
...
ax.set_xlabel('PREDICTED VALUES')
ax.set_ylabel('ACTUAL VALUES')
plt.savefig('./prediction/confusion_matrix_normalised_val.png')
plt.savefig('./prediction/confusion_matrix_normalised_val.svg')
