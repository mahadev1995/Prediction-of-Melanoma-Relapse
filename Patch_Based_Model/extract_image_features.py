...
ckpt_path = '/home/woody/iwso/iwso089h/VisioMel/seminar/stiching/checkpoints/resnet34_imageonly_bce_loss/checkpoint_9.ckp'
...
# Define image transformations for normalization
...
# Load dataframes containing filenames and labels for training, validation, and test sets
...
# Extract image features for training data
...
for filename in filenames:
    ...
    img_path = f'./stiched_images/{relapse.item()}/{img_name}'
...
np.save('./data/train_image_features_new.npy', train_image_features_np)
...
np.save('./data/val_images_features_new.npy', val_images_features_np)
...
np.save('./data/test_images_features.npy', test_images_features)
